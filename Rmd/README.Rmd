...
include_img <- function(url) {
    ...
    knitr::include_graphics(if (identical(knitr:::pandoc_to(), 'pdf_document')) img_path else url)
}
```
...
![]("img/Fig_2d_ScholarlyImpact2016.png"")
...
`r include_img("ttp://sogrady-media.redmonk.com/sogrady/files/2018/08/lang.rank_.618-1.png")`
